    ...
    <div class="col-md-4 mt-4">
      <div class="p-4 bg-dark border rounded-3">
        ...
        <p class="lead text-white">
          Este projeto utiliza a API do Google Books para disponibilizar a busca de livros. É
          possível buscar, ver detalhes e favoritar seus livros preferidos.
        </p>
        <hr />
        <p>O objetivo foi estudar conceitos de Vue.js e relembrar HTML, CSS e JS.</p>
      </div>
    </div>

    <div class="col-md-8">
      <form>
        <h5 class="alert">Digite o nome do livro que deseja na barra de pesquisa!</h5>
        ...
        <div class="row">
          <div
            v-for="livro in livrosEncontrados"
            :key="livro.id"
